...
// Asset simulates an `channel.Asset` by only containing an `ID`
type Asset struct {
	ID int64
}
...
// Encode encodes a MockAsset into the io.Writer `w`
func (a Asset) Encode(w io.Writer) error {
	return wire.Encode(w, a.ID)
}

// Decode decodes a MockAsset from the io.Reader `r`
